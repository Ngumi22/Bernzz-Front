...
const ProductCard: React.FC<CardProps> = ({
  ...
  return (
    <Card className="group group/item relative p-2 font-sans">
      <div
        className={cn(
          "block",
          imageLeft
        ...
        <div
          className={
            "aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg xl:aspect-w-7 xl:aspect-h-8"
          }>
          <Image
          ...
          <p className="group/edit invisible group-hover/item:visible absolute top-1 left-1 text-sm bg-black border px-2 py-1 text-white">
            - {product.discount} %
          </p>
        </div>
        <div className="flex flex-col justify-between py-4 px-2 gap-4">
          <h3 className="text-gray-900 text-lg font-semibold line-clamp-6">
            {product.name}
          </h3>
          <div className="flex items-center justify-between text-sm gap-x-2">
            <p className="line-through font-semibold text-gray-900">
